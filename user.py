...
conn = DBHelper._ini_()
reply_keyboard = ReplyKeyboardMarkup(keyboard=[['I want to reply','Send a Message','Receive a Message']], one_time_keyboard=True, resize_keyboard=True)
reply_keyboard2 = ReplyKeyboardMarkup(keyboard=[['Like'],['I want to reply',],['Send a Message',],['Receive another Message',],['Report this message as spam',]], one_time_keyboard=True, resize_keyboard=True)
reply_keyboard3 = ReplyKeyboardMarkup(keyboard=[['Like'],['Send a Message',],['Receive another Message',]], one_time_keyboard=True, resize_keyboard=True)
reply_keyboard4 = ReplyKeyboardMarkup(keyboard=[['I want to reply',],['Send a Message',],['Receive another Message',]], one_time_keyboard=True, resize_keyboard=True)
keyboard = ReplyKeyboardMarkup(keyboard=[['Send a Message', 'Receive a Message']], one_time_keyboard=True, resize_keyboard=True)
keyboard1 = ReplyKeyboardMarkup(keyboard=[['Send another Message',],[ 'Receive a Message',]], one_time_keyboard=True, resize_keyboard=True)
...
#top 10
        ...
        if content_type == 'text' and content == '/start':
        ...
        elif content_type == 'text' and (content == 'Send a Message' or content == 'Send another Message'):
        ...
        elif content_type == 'text' and (content == 'Receive a Message' or content == 'Receive another Message'):
            ...
            bot.sendMessage(chat_id, 'Hey! Please enter your comment! It will be posted to the original sender of the above message! Hope you two could become friends or just remain strangers :D')
            ...
            bot.sendMessage(chat_id,"Thanks for your report, our administer would look into this", reply_markup = keyboard1)
            ...
            bot.sendMessage(chat_id,"Sure, please enter your message agin.")
        else:
            last_message = DBHelper.get_last_message(conn,chat_id)
            if last_message == 'Send a Message' or  last_message == 'Send another Message' or  last_message == 'Enter again':
